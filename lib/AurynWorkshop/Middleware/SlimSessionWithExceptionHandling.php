 ...
 * ATTENTION
 *
 * This class is the same as the slim framework Session Middleware class, except it also
 * catches exceptions around session start, so that the encryted session data failures
 * don't continually redirect the user.
 *
 *
 * Session middleware
 *
 ...
 * @author  Bryan Horna
 */
class SlimSessionWithExceptionHandling
{
    /**
     * @var array
     */
