...
class CreateUserWithCredentialsParams
{
    /** @var  string */
    private $username;
    ...
    public static function fromVarMap(VariableMap $varMap) : CreateUserWithCredentialsParams
    {
        ...
        return new CreateUserWithCredentialsParams($username, $password);
    }
